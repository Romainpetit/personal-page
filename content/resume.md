...
- Startup software development: React.js, SASS, OAuth.
...
- Creation of a Design System in React.js for the [Once For All](https://www.onceforall.com/) project, a platform generating legal documents.
- Extension of the Material-UI library project
...
- Design of a data visualisation system for running battery cyclers.
- Developement a graphing webapp with [plotly.js](https://github.com/plotly/plotly.js).

#### [Megapix'ailes](https://www.megapixailes.com/)

Jan. 2017 → Apr. 2017

_Grenoble._

- Front-end development and product conception on SkewerLab — https://skewerlab.com
- Newsletter development, PSD to HTML integration and cross email clients development.
...
- Long term continuous improvement of the front-end part of the product.
- Complete overhaul of the corporate website: new visual identity definition and website development — https://www.leadformance.com

[Routine](https://www.routine.co/)
[Et Si](https://etsicommunication.fr/)
